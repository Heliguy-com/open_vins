...
# FIXME: Make sure to link the ROS Nodes for vision_opencv and image_common which are needed by openvins
...
# make sure build succeeded TODO: Check if prereqs were also installed
if ! [[ -d "colcon_ws_qrb5165/install/" ]]; then
...
mkdir -p $DATA_DIR/opt/ros/${ROS_DIST}/open_vins
cp -r colcon_ws_qrb5165/install/  $DATA_DIR/opt/ros/${ROS_DIST}/open_vins
cp -r colcon_ws_qrb5165/build/ $DATA_DIR/opt/ros/${ROS_DIST}/open_vins
